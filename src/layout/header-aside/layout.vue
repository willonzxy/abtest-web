    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div class="d2-theme-header" :style="{ opacity: this.searchActive ? 0.5 : 1 }" flex-box="0" flex>
        <router-link
          ...
          <!-- <img src="/image/icon-only.png" alt="anbu-logo" srcset="" width="120px" height="60px" style=""> -->
          <h3 :style="{color:themeActiveSetting.name ==='d2' || themeActiveSetting.name ==='line' ? '#333' : '#f0f0f0'}" v-if="!asideCollapse">AB Test</h3>
          <h3 :style="{color:themeActiveSetting.name ==='d2' || themeActiveSetting.name ==='line'? '#333' : '#f0f0f0'}" v-else>AB Test</h3>
        </router-link>
